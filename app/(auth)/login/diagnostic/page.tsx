...
import { Activity, ArrowLeft, Loader2, KeyRound } from 'lucide-react'
...
export default function DiagnosticLoginPage() {
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    if (res.error) {
      ...
      setView('login')
      setResetError('')
      alert('We have sent a magic reset link to your registered email address.')
    }
  }
    ...
    return (
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-gray-200">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1 text-center">Enter your Center Admin ID to receive a reset link on your registered email.</p>
        </div>
        ...
        <form onSubmit={handleSendOTP} className="space-y-4">
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">Center Admin ID</label>
            <input
              required
              value={staffId}
  ...
  return (
    <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-gray-200">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Diagnostic Portal</h1>
        <p className="text-gray-500 text-sm mt-1">Sign in with your Admin ID to manage your center</p>
      </div>
