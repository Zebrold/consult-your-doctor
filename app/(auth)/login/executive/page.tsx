...
import { ArrowLeft, Loader2, ShieldCheck, Clock, Star, HeadphonesIcon, IdCard, Lock, Unlock, UserCheck } from 'lucide-react'
        ...
        <div className="bg-gradient-to-b from-[#F3F5FA] to-[#E9F0FA] rounded-[2rem] p-6 lg:p-14 flex flex-col justify-between relative overflow-hidden order-2 lg:order-1">
          <div className="relative z-10 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
              <div className="p-6 rounded-2xl bg-white shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xs font-black text-slate-600 tracking-wider">RESPONSE TIME</span>
                  <Clock className="w-5 h-5 text-[#1FA67A]" />
                </div>
                <h3 className="text-lg font-black text-[#0949B3] mb-1.5">&lt; 5 Minutes</h3>
              ...
              <div className="p-6 rounded-2xl bg-white shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xs font-black text-slate-600 tracking-wider">ACTIVE CASES</span>
                  <UserCheck className="w-5 h-5 text-[#0949B3]" />
                </div>
                <h3 className="text-lg font-black text-[#0949B3] mb-1.5">120+ Patients</h3>
                <p className="text-xs text-slate-600 font-bold">receiving direct support</p>
              </div>
            </div>
            ...
            <div className="mt-4 bg-white rounded-2xl p-6 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <Star className="w-5 h-5 text-[#0949B3]" />
                  <div>
                    <h3 className="text-sm font-black text-[#0949B3]">VIP Routing</h3>
                    <p className="text-[11px] font-bold text-slate-500">Priority Queue · Executive Privileges</p>
                  </div>
                </div>
              ...
              <div className="bg-[#F8F9FC] rounded-xl p-4 flex items-center justify-between">
                <div>
                  <p className="text-[10px] font-black text-slate-500 tracking-wider mb-0.5">SATISFACTION</p>
                  <p className="text-[15px] font-black text-[#0949B3]">98% Positive Rating</p>
                </div>
          ...
          <div className="relative z-10 mt-8 bg-white/50 backdrop-blur-md rounded-2xl p-6 border border-white/60">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-full overflow-hidden bg-gray-200 relative shrink-0">
                <Image src="https://lh3.googleusercontent.com/aida-public/AB6AXuD7AOMW1vR8o2TkE-Hgt9jlXdXYZtd4f1L3eAw2cfPWrqI0c_ta_z9VDTZgucG0O9oK_hpjkkS-oxx8_KjekxnJjU3VCZ0bC_i8uIlU9KRY2iMtYuCN-0dg7dl0o-3k1VR6BKHNUM0zTMlXbVKNFfL5Vn7CFUQek5n0dHF31WHgpNHvNmkP7X53Xl4EdVJExVm3NmOoSZyMq0VQ2iAipcm9jNoIGMFwqUd5X6DhS-438yNyL7T-_BA3Hg" alt="Head of Patient Experience" fill className="object-cover" />
              </div>
              <div>
                <p className="text-[13px] italic text-[#0949B3] font-bold leading-relaxed mb-3">
                  "Our platform empowers executives to deliver a frictionless healthcare journey, ensuring patients feel supported every step of the way."
                </p>
                <div className="flex items-center gap-2">
                  <span className="text-sm font-black text-[#0949B3]">Michael Chang</span>
                  <span className="text-xs font-bold text-slate-500 border-l border-slate-300 pl-2">Head of Patient Experience</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-[2rem] p-6 lg:p-16 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col justify-start border border-slate-100 order-1 lg:order-2">
          ...
          {view === 'login' && (
            <div>
              ...
              <div className="mb-10">
                <span className="text-[13px] font-black text-[#096348] uppercase tracking-widest mb-3 block">Support Access</span>
                ...
                <p className="text-slate-600 text-[15px] font-medium mt-4 leading-relaxed max-w-sm">
                  Restricted to authorized patient care executives and coordinators.
                </p>
              </div>
              ...
              <form action={formAction} className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex justify-between items-center mb-1">
                    <label className="text-sm font-bold text-slate-700">Account Password</label>
                    <button
                      type="button"
                ...
                <div className="flex items-start gap-3 mt-2">
                  ...
                  <label className="text-sm text-slate-600 font-medium cursor-pointer leading-relaxed" htmlFor="workstationPersist">
                    Maintain active session <span className="text-[#0949B3] font-bold">(Only on registered devices)</span>
                  </label>
                </div>
          ...
          <div className="mt-10 pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <HeadphonesIcon className="w-8 h-8 text-[#0949B3]" />
              <div>
                <p className="text-sm font-black text-[#0949B3]">Need help?</p>
                <p className="text-xs font-bold text-slate-500">Contact IT Support for access issues</p>
              </div>
            </div>
