...
import { ArrowLeft, Loader2, ShieldCheck, RefreshCcw, Users, Activity, IdCard, Lock, Unlock, Building2 } from 'lucide-react'
          ...
          <div className="relative z-10 flex flex-col gap-6">
            ...
            <div className="mt-8">
              ...
              <p className="text-[17px] text-slate-600 mt-6 leading-relaxed max-w-md font-medium">
                Centralized oversight for admissions, staffing, and multi-departmental resource orchestration with real-time operational telemetry.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
              <div className="p-6 rounded-2xl bg-white shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xs font-black text-slate-600 tracking-wider">BED MANAGEMENT</span>
                  <RefreshCcw className="w-5 h-5 text-[#1FA67A]" />
                </div>
                <h3 className="text-lg font-black text-[#0949B3] mb-1.5">Live Occupancy</h3>
              ...
              <div className="p-6 rounded-2xl bg-white shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xs font-black text-slate-600 tracking-wider">ACTIVE STAFF</span>
                  <Users className="w-5 h-5 text-[#0949B3]" />
                </div>
                <h3 className="text-lg font-black text-[#0949B3] mb-1.5">2,450+ Personnel</h3>
                <p className="text-xs text-slate-600 font-bold">across 12 departments</p>
              </div>
            </div>
            ...
            <div className="mt-4 bg-white rounded-2xl p-6 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-black text-[#0949B3]">Operational Telemetry</h3>
                    <p className="text-[11px] font-bold text-slate-500">Resource Utilization · 256-bit AES Enclave</p>
                  </div>
                </div>
              ...
              <div className="bg-[#F8F9FC] rounded-xl p-4 flex items-center justify-between">
                <div>
                  <p className="text-[10px] font-black text-slate-500 tracking-wider mb-0.5">PATIENT FLOW</p>
                  <p className="text-[15px] font-black text-[#0949B3]">Optimized Routing</p>
                </div>
          ...
          <div className="relative z-10 mt-8 bg-white/50 backdrop-blur-md rounded-2xl p-6 border border-white/60">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-full overflow-hidden bg-gray-200 relative shrink-0">
                <Image src="https://lh3.googleusercontent.com/aida-public/AB6AXuB6uhXvtzWITDpDpJT9SrPzufUry7hJFYJC2y7Qjy-oD1HI6z6Z9eYzOF9iVadJzQLjQ5BwX7-XRPtbZQUa0WjtAPXJjrVfpq5YtnmaIk3IvKL7Bunvi1GNnIfshpiwOXOzA3Mc69SxnuXW-z2I8Tq9ZycrFUuStuU_1yV_vnqxDV8fva3d5p1oao_NVL7DYwmlpOMrg7eqqOk3iz6rTk-fnoV2UdViTwH1zQGTq6uyejVK25diQLX6oA" alt="Hospital Administrator" fill className="object-cover" />
              </div>
              <div>
                <p className="text-[13px] italic text-[#0949B3] font-bold leading-relaxed mb-3">
                  "Having complete visibility into our facility's operations allows us to allocate resources efficiently and maintain the highest standard of patient care."
                </p>
                <div className="flex items-center gap-2">
                  <span className="text-sm font-black text-[#0949B3]">Dr. Robert Chen, MHA</span>
                  <span className="text-xs font-bold text-slate-500 border-l border-slate-300 pl-2">Hospital Administrator</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-[2rem] p-6 lg:p-16 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col justify-start border border-slate-100 order-1 lg:order-2">
          ...
          {view === 'login' && (
            <div>
              ...
              <div className="mb-10">
                <span className="text-[13px] font-black text-[#096348] uppercase tracking-widest mb-3 block">Facility Access</span>
                ...
                <p className="text-slate-600 text-[15px] font-medium mt-4 leading-relaxed max-w-sm">
                  Restricted to authorized hospital administrators and facility managers.
                </p>
              </div>
              ...
              <form action={formAction} className="flex flex-col gap-6">
                ...
                <div className="flex items-start gap-3 mt-2">
                  ...
                  <label className="text-sm text-slate-600 font-medium cursor-pointer leading-relaxed" htmlFor="workstationPersist">
                    Maintain active session on this secure endpoint <span className="text-[#0949B3] font-bold">(Hospital intranet or registered device only)</span>
                  </label>
                </div>
          ...
          <div className="mt-10 pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-black text-[#0949B3]">New facility?</p>
                <p className="text-xs font-bold text-slate-500">Apply to join our accredited network</p>
              </div>
            </div>
