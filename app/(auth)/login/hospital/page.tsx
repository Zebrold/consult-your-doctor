...
import { Building2, ArrowLeft, Loader2, KeyRound } from 'lucide-react'
...
export default function HospitalLoginPage() {
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    if (res.error) {
      ...
      setView('login')
      setResetError('')
      // Show success message or redirect, but since it's magic link, 
      // we can just show an alert or set a success state
    ...
    return (
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1 text-center">Enter your Staff ID to receive a reset link on your registered email.</p>
        </div>
