    ...
    <section className="py-24 px-4 md:px-margin-x-desktop bg-surface">
      <div className="max-w-container-max mx-auto reveal-up">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-12">
          <h2 className="font-headline-lg text-2xl md:text-headline-lg text-primary font-bold">Featured Hospitals</h2>
          <div className="flex items-center gap-4">
            <Link href="/search?type=hospital" className="text-vibrant-blue font-bold text-sm hover:underline flex items-center gap-1 cursor-pointer whitespace-nowrap">
